...
public class InstantInvGui {
  public InstantInvGui(Player player) {
    Inventory inventory = Bukkit.createInventory(null, 27, ChatColor.GREEN + "Instant Inventory freischalten");
